#!MANAGED-CONFIG https://ssthy.net/link/SiU6a4wtRCJPLEoG?clash=1

#---------------------------------------------------#
## 上次更新于：2022-10-17 01:52:51
#---------------------------------------------------#
...
proxies:
  -
    name: '国内 ssthy.net | x0.3 '
    type: vmess
    server: s400l.cmcuct.org
    port: 24488
    uuid: d459c8f1-5dd8-379d-9e81-890184b529d3
    alterId: 0
    cipher: auto
    udp: true
    servername: us.domain.com
    network: ws
    ws-path: /download
    ws-headers:
      Host: us.domain.com
